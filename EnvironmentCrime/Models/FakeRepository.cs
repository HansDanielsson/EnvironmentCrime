namespace EnvironmentCrime.Models
{
  public class FakeRepository : IERepository
  {
    ...
    public Errand GetErrandDetail(string errandid)
    {
      return Errands.FirstOrDefault(ed => ed.ErrandId == errandid)!;
    }
  }
}
